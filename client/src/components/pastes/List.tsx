        ...
        {pastes.pastes.map((x, i) => (
          <div key={i} className="border-t border-gray-200">
            <div
              className={
                i % 2 == 0
                  ? "bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 flex justify-center items-center"
                  : "bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 flex justify-center items-center"
              }
            >
              <dt
                className={
